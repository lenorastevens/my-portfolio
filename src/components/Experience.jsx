...
const Experience = () => {
  ...
  return (
    <div name="experience" className='bg-gradient-to-b from-cyan-600 to-cyan-950 w-full md:h-screen text-white pt-20 '>
        <div className='max-w-screen-lg mx-auto p-4 flex flex-col justify-center w-full h-full '>
           <div>
            ...
            <div className='w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 text-center py-6 px-12 sm:px-0'>
